...
<head>
    ...
    <script src=<?= base_url("dist/js/jquery.mapael.min.js") ?> charset="utf-8"></script>
    <script src=<?= base_url("dist/js/maps/france_departments.js") ?> charset="utf-8"></script>
    <script src=<?= base_url("dist/js/maps/world_countries.js") ?> charset="utf-8"></script>
    <script src=<?= base_url("dist/js/maps/usa_states.js") ?> charset="utf-8"></script>
